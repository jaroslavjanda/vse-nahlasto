                    ...
                    <Row>
                        ...
                        <Col lg={4} sm={6}>
                            ...
                            >
                                ...
                                <div className="px-4 pb-5">
                                    <h5>
                                        API k propojení Nahlaš.To na vlastní
                                        systém
                                    </h5>
                                </div>
                            </div>
                        ...
                        <Col lg={6}>
                            <div className="info">
                                ...
                                <p>
                                    ...
                                    jakémkoliv mobilu, ať už máte Android nebo
                                    iOS. Snažíme se o čistý design, který vás
                                    sám o sobě bude navádět, jak aplikaci
                                    používat.
                                </p>
                            </div>
                        </Col>
                        ...
                        <Row>
                                ...
                                <Card>
                                    <Card.Body>
                                        <Card.Text className="testimonial">
                                            "Nahlaš.To používám v práci téměř
                                            každý den."
                                        </Card.Text>
                            ...
                            <Col lg={6} sm={6}>
                                <Card>
                                    <Card.Body>
                                        <Card.Text className="testimonial">
                                            "Když se něco rozbije u nás v
                                            bytovce, snadno to nahlásím."
                                        </Card.Text>
                                        <div className="avatar-author">
                                            <img
                                                alt="uživatel"
